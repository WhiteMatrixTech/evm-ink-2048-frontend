...
* @returns {HistoryReconstruction}
*/
export function reconstruct_recording(data) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {string}
*/
export function validate_all(data) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {Board}
*/
export function initial_board(size, seed, add_tiles) {
...
* @returns {string}
*/
export function new_game(size, seed) {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {GameState}
*/
export function get_gamestate(data) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(data, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
...
* @returns {GameState}
*/
export function get_gamestate_from_recording(data) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {MoveResult}
*/
export function apply_move(board, dir, add_random) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.apply_move(retptr, addHeapObject(board), addHeapObject(dir), add_random);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
* @returns {Board}
*/
export function add_random(board) {
...
* @returns {string}
*/
export function hash_recording(data) {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
